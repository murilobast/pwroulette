...
```bash
$ git clone git@github.com:RedVentures/www.iq360.com.br.git <project-name>
$ cd <project-name>
```
...
| start:server   | Starts production server; served at `localhost:8080`          |
...
----- ducks            # directory for redux actions and reducers
----- assets           # directory for assets like images, fonts and etc...
----- pages            # directory for page components
----- styles           # directory for application styles (in scss format)
--------- abstrations  # stylus code that doesn`t compile into actual code (variables, functions and etc...)
--------- base         # global styles
```
